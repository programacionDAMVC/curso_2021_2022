...
public interface Figura {
    ...
    static Figura devolverFiguraMasArea (List<Figura> listaFiguras) {
        Figura figuraMasArea = null;
        double areaMasGrande = 0;
        for (Figura figura: listaFiguras) {
            if (figura.calcularArea() > areaMasGrande) {
                areaMasGrande = figura.calcularArea();
                figuraMasArea = figura;
            }
        }
         return figuraMasArea;
    }


    default void mostrarEnConsolaDatosFigura() {
